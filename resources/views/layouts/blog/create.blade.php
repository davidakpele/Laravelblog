                                    ...
                                    <div class="pad-con fl-wrap">
                                        ...
                                        <div id="contact-form" style="margin-top: 20px;">
                                            ...
                                            enctype="multipart/form-data" >
                                                @csrf
                                                <fieldset>
                                                    <input type="text" name="title" id="title" placeholder="Post Title:*" value=""/>
                                                    <input type="text" name="details" id="details" placeholder="Brief Detail Of This Post:*" value=""/>
                                                    <input type="file" name="image" id="image" placeholder="Post Image:*" value="" />
                                                    <textarea name="description"  id="description" cols="40" rows="3" placeholder="Post Description:*"></textarea>
                                                </fieldset>
