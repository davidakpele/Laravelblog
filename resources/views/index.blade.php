                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="bg-wrap">
                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/20.jpg') }}" data-swiper-parallax="40%"></div>
                            ...
                            <div class="hero-item fl-wrap">
                                <div class="container">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/4.jpg') }}" alt="">  <span>By Jessie Bond</span></a></div>
                        ...
                        <div class="swiper-slide">
                            <div class="bg-wrap">
                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/55.jpg') }}" data-swiper-parallax="40%"></div>
                                <div class="overlay"></div>
                            </div>
                            <div class="hero-item fl-wrap">
                                <div class="container">
                                    ...
                                    <div class="clearfix"></div>
                                    <h2><a href="post-single.html">Here's the proof that momentum strategies work </a></h2>
                                    <h4>Lorem ipsum dosectetur adipisicing elit, sed do.Lorem ipsum dolor sit amet, consectetur Nulla fringilla purus at leo dignissim congue. </h4>
                                    <div class="clearfix"></div>
                                    <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/3.jpg') }}" alt="">  <span>By Ann Kowalsky</span></a></div>
                        ...
                        <div class="swiper-slide">
                            <div class="bg-wrap">
                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/56.jpg') }}" data-swiper-parallax="40%"></div>
                                <div class="overlay"></div>
                            </div>
                            <div class="hero-item fl-wrap">
                                <div class="container">
                                    <a class="post-category-marker" href="category.html">Politics</a>
                                    <div class="clearfix"></div>
                                    <h2><a href="post-single.html">How Maps Reshape American Politics In World</a></h2>
                                    <h4>Lorem ipsum dosectetur adipisicing elit, sed do.Lorem ipsum dolor sit amet, consectetur Nulla fringilla purus at leo dignissim congue. </h4>
                                    <div class="clearfix"></div>
                                    <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/2.jpg') }}" alt="">  <span>By Mark Rose</span></a></div>
                                    <span class="post-date"><i class="far fa-clock"></i> 22 march 2022</span>
                                </div>
                            </div>
                        </div>
                        <!-- swiper-slide  end   -->
                        ...
                        <div class="swiper-slide">
                            <div class="bg-wrap">
                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/57.jpg') }}" data-swiper-parallax="40%"></div>
                                <div class="overlay"></div>
                            </div>
                            <div class="hero-item fl-wrap">
                                <div class="container">
                                    ...
                                    <div class="clearfix"></div>
                                    <h2><a href="post-single.html">First prototype flight using kinetic launch system</a></h2>
                                    <h4>Lorem ipsum dosectetur adipisicing elit, sed do.Lorem ipsum dolor sit amet, consectetur Nulla fringilla purus at leo dignissim congue. </h4>
                                    <div class="clearfix"></div>
                                    <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/1.jpg') }}" alt="">  <span>By Jane Taylor</span></a></div>
                                    <span class="post-date"><i class="far fa-clock"></i> 15 March 2022</span>
                                </div>
                            </div>
                        </div>
                        <!-- swiper-slide  end   -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="hsc-list_item fl-wrap">
                                        <div class="hsc-list_item-media">
                                            <div class="bg-wrap">
                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets//all/20.jpg') }}"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="hsc-list_item fl-wrap">
                                        <div class="hsc-list_item-media">
                                            <div class="bg-wrap">
                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/55.jpg') }}"></div>
                                            </div>
                                        </div>
                                        <div class="hsc-list_item-content fl-wrap">
                                            <h4>Here's the proof that momentum strategies work </h4>
                                            <span class="post-date"><i class="far fa-clock"></i>   05 April 2022</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="hsc-list_item fl-wrap">
                                        <div class="hsc-list_item-media">
                                            <div class="bg-wrap">
                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/56.jpg') }}"></div>
                                            </div>
                                        </div>
                                        <div class="hsc-list_item-content fl-wrap">
                                            <h4>How Maps Reshape American Politics In World</h4>
                                            <span class="post-date"><i class="far fa-clock"></i> 15 March 2022</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="hsc-list_item fl-wrap">
                                        <div class="hsc-list_item-media">
                                            <div class="bg-wrap">
                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/57.jpg') }}"></div>
                                            </div>
                                        </div>
                                        <div class="hsc-list_item-content fl-wrap">
                                            <h4>First prototype flight using kinetic launch system</h4>
                                            <span class="post-date"><i class="far fa-clock"></i>    15 March 2022</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-8">
                        <div class="main-container fl-wrap fix-container-init">
                            <div class="section-title">
                                ...
                                <div class="ajax-nav">
                                    <ul>
                                        <li><a href="/category1" class="current_page">World</a></li>
                                        <li><a href="/category2">Technology</a></li>
                                        <li><a href="/category3">Business</a></li>
                                        <li><a href="/category4">Sports</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="ajax-wrapper fl-wrap">
                                <div class="ajax-loader"><img src="{{ Vite::asset('resources/assets/images/loading.gif') }}" alt=""/></div>
                                <div id="ajax-content" class="fl-wrap">
                                </div>
                            </div>
                            <div class="content-banner-wrap cbw_mar">
                                <img src="{{ Vite::asset('resources/assets/images/all/banner.jpg') }}" class="respimg" alt="">
                            </div>
                            <div class="clearfix"></div>
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/16.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/24.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                                        <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                    </div>
                                        ...
                                        <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item  bold_gpi  fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/31.jpg') }}"></div>
                                                            <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/2.jpg') }}" alt="">  <span>By Mark Rose</span></a></div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item  bold_gpi  fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/40.jpg') }}"></div>
                                                            <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/3.jpg') }}" alt="">  <span>Ann Kowalsky</span></a></div>
                                                            <div class="grid-post-media_title">
                                                                <a class="post-category-marker" href="category.html">Business</a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item  bold_gpi  fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/36.jpg') }}"></div>
                                                            <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/1.jpg') }}" alt="">  <span>By Jane Taylor</span></a></div>
                                                            <div class="grid-post-media_title">
                                                                <a class="post-category-marker" href="category.html">Technology</a>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/37.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                                        <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/39.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                                        <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/18.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                                        <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="list-post fl-wrap">
                                                    ...
                                                    <div class="list-post-media">
                                                        <a href="post-single.html">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/7.jpg') }}"></div>
                                                            </div>
                                                        </a>
                                                        <span class="post-media_title">&copy; Image Copyrights Title</span>
                                                    </div>
                                                    ...
                                                    <div class="post-widget-container fl-wrap">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/1.jpg') }}"  alt=""></a>
                                                            </div>
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/2.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/3.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/4.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                            ...
                                            <div class="tab">
                                                <div id="tab-resent" class="tab-content">
                                                    <div class="post-widget-container fl-wrap">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/5.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/6.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                                        ...
                                                        <div class="post-widget-item fl-wrap">
                                                            <div class="post-widget-item-media">
                                                                <a href="post-single.html"><img src="{{ Vite::asset('resources/assets/images/all/thumbs/7.jpg') }}"  alt=""></a>
                                                            </div>
                                                            <div class="post-widget-item-content">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item     fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/21.jpg') }}"></div>
                                                                <div class="overlay"></div>
                                                            </div>
                                                            <div class="grid-post-media_title">
                                                                <a class="post-category-marker" href="category.html">Technology</a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item  bold_gpi  fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/41.jpg') }}"></div>
                                                                <div class="overlay"></div>
                                                            </div>
                                                            <div class="grid-post-media_title">
                                                                <a class="post-category-marker" href="category.html">Politics</a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="grid-post-item  bold_gpi  fl-wrap">
                                                        <div class="grid-post-media gpm_sing">
                                                            <div class="bg-wrap">
                                                                <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/22.jpg') }}"></div>
                                                                <div class="overlay"></div>
                                                            </div>
                                                            <div class="grid-post-media_title">
                                                                <a class="post-category-marker" href="category.html">Technology</a>
                    ...
                    <div class="video-links-wrap">
                        ...
                        <div class="video-item video-item_active fl-wrap" data-url="post-single2.html" data-video-link="https://www.youtube.com/watch?v=VLoqKdRxPSc">
                            <div class="video-item-img fl-wrap">
                                <img src="{{ Vite::asset('resources/assets/images/all/33.jpg') }}" class="respimg" alt="">
                        ...
                        <div class="video-item fl-wrap" data-url="post-single2.html" data-video-link="https://www.youtube.com/watch?v=K-6tPkm6cZA">
                            <div class="video-item-img fl-wrap">
                                <img src="{{ Vite::asset('resources/assets/images/all/43.jpg') }}" class="respimg" alt="">
                                <div class="play-icon"><i class="fas fa-play"></i></div>
                            </div>
                            <div class="video-item-title">
                        ...
                        <div class="video-item fl-wrap" data-url="posts-ingle2.html" data-video-link="https://vimeo.com/390742893">
                            <div class="video-item-img fl-wrap">
                                <img src="{{ Vite::asset('resources/assets/images/all/3.jpg') }}" class="respimg" alt="">
                                <div class="play-icon"><i class="fas fa-play"></i></div>
                            </div>
                            <div class="video-item-title">
                        ...
                        <div class="video-item fl-wrap" data-url="post-single2.html" data-video-link="https://www.youtube.com/watch?v=vgVr_OpEVMQ">
                            <div class="video-item-img fl-wrap">
                                <img src="{{ Vite::asset('resources/assets/images/all/42.jpg') }}" class="respimg" alt="">
                                <div class="play-icon"><i class="fas fa-play"></i></div>
                            </div>
                            <div class="video-item-title">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="video-item fl-wrap">
                                            <div class="video-item-img fl-wrap">
                                                <img src="{{ Vite::asset('resources/assets/images/all/1.jpg') }}" class="respimg" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="video-item fl-wrap">
                                            <div class="video-item-img fl-wrap">
                                                <img src="{{ Vite::asset('resources/assets/images/all/44.jpg') }}" class="respimg" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="video-item fl-wrap">
                                            <div class="video-item-img fl-wrap">
                                                <img src="{{ Vite::asset('resources/assets/images/all/2.jpg') }}" class="respimg" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="video-item fl-wrap">
                                            <div class="video-item-img fl-wrap">
                                                <img src="{{ Vite::asset('resources/assets/images/all/46.jpg') }}" class="respimg" alt="">
                        ...
                        <div class="list-post-wrap list-post-wrap_column list-post-wrap_column_fw">
                            ...
                            <div class="list-post fl-wrap">
                                ...
                                <div class="list-post-media">
                                    <a href="post-single.html">
                                        <div class="bg-wrap">
                                            <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/15.jpg') }}"></div>
                                        </div>
                                    </a>
                                    <span class="post-media_title">&copy; Image Copyrights Title</span>
                                </div>
                                ...
                                <div class="list-post-wrap  fl-wrap">
                                    ...
                                    <div class="list-post fl-wrap">
                                        <div class="list-post-media">
                                            <a href="post-single.html">
                                                <div class="bg-wrap">
                                                    <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/5.jpg') }}"></div>
                                                </div>
                                            </a>
                                            <span class="post-media_title">&copy; Image Copyrights Title</span>
                                        </div>
                                    ...
                                    <div class="list-post fl-wrap">
                                        <div class="list-post-media">
                                            <a href="post-single.html">
                                                <div class="bg-wrap">
                                                    <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/48.jpg') }}"></div>
                                                </div>
                                            </a>
                                            <span class="post-media_title">&copy; Image Copyrights Title</span>
                                        </div>
                                    ...
                                    <div class="list-post fl-wrap">
                                        <div class="list-post-media">
                                            <a href="post-single.html">
                                                <div class="bg-wrap">
                                                    <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/2.jpg') }}"></div>
                                                </div>
                                            </a>
                                            <span class="post-media_title">&copy; Image Copyrights Title</span>
                                        </div>
                                    ...
                                    <div class="list-post fl-wrap">
                                        <div class="list-post-media">
                                            <a href="post-single.html">
                                                <div class="bg-wrap">
                                                    <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/49.jpg') }}"></div>
                                                </div>
                                            </a>
                                            <span class="post-media_title">&copy; Image Copyrights Title</span>
                                        </div>
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="grid-post-item  bold_gpi  fl-wrap">
                                    <div class="grid-post-media gpm_sing">
                                        <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/50.jpg') }}"></div>
                                        <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/2.jpg') }}" alt="">  <span>By Mark Rose</span></a></div>
                                        <div class="grid-post-media_title">
                                            <a class="post-category-marker" href="category.html">Business</a>
                            ...
                            <div class="swiper-slide">
                                <div class="grid-post-item  bold_gpi  fl-wrap">
                                    <div class="grid-post-media gpm_sing">
                                        <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/53.jpg') }}"></div>
                                        <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/3.jpg') }}" alt="">  <span>By Ann Kowalsky</span></a></div>
                                        <div class="grid-post-media_title">
                                            <a class="post-category-marker" href="category.html">Technology</a>
                                            <h4><a href="post-single.html">Videos show SpaceX's Dragon capsule as it returns to Earth</a></h4>
                            ...
                            <div class="swiper-slide">
                                <div class="grid-post-item  bold_gpi  fl-wrap">
                                    <div class="grid-post-media gpm_sing">
                                        <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/54.jpg') }}"></div>
                                        <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/2.jpg') }}" alt="">  <span>By Mark Rose</span></a></div>
                                        <div class="grid-post-media_title">
                                            <a class="post-category-marker" href="category.html">Sports</a>
                            ...
                            <div class="swiper-slide">
                                <div class="grid-post-item  bold_gpi  fl-wrap">
                                    <div class="grid-post-media gpm_sing">
                                        <div class="bg" data-bg="{{ Vite::asset('resources/assets/images/all/52.jpg') }}"></div>
                                        <div class="author-link"><a href="author-single.html"><img src="{{ Vite::asset('resources/assets/images/avatar/1.jpg') }}" alt="">  <span>By Jane Taylor</span></a></div>
                                        <div class="grid-post-media_title">
                                            <a class="post-category-marker" href="category.html">Science</a>
